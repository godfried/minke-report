...
The Directions Viewer will function in the same fashion as the GWT Directions Viewer. 
The library used for this will be the Google Maps API for Android~\cite{amaps}. 
Directions will be obtained from Google's Directions API via a HTTP request and using JSON to hold the data.
